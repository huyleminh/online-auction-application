create schema if not exists `heroku_9a602603f4f0dfb` default character set utf8mb4 default collate utf8mb4_bin;
use `heroku_9a602603f4f0dfb`;

-- -----------------------------------------------------
-- Table `user_account`
-- -----------------------------------------------------
-- 0 is bidder, 1 is admin
create table if not exists `heroku_9a602603f4f0dfb`.`user_account` (
...
-- Table `rating`
-- -----------------------------------------------------
create table if not exists `heroku_9a602603f4f0dfb`.`rating` (
...
create table if not exists `heroku_9a602603f4f0dfb`.`product_detail` (
    `product_id` int unsigned auto_increment,
...
-- -----------------------------------------------------
create table if not exists `heroku_9a602603f4f0dfb`.`auto_bidding_job` (
...
-- -----------------------------------------------------
create table if not exists `heroku_9a602603f4f0dfb`.`bidding_history` (
...
-- Table `join_bidder`
-- -----------------------------------------------------
create table if not exists `heroku_9a602603f4f0dfb`.`join_bidder` (
    `product_id` int unsigned not null,
    `bidder_id` int unsigned not null,
...
-- Create foreign keys
-- -----------------------------------------------------
alter table `heroku_9a602603f4f0dfb`.`upgrade_request`
add constraint `FK_UPGRADE_REQUEST_USER_ACCOUNT`
foreign key (user_id)
references `heroku_9a602603f4f0dfb`.`user_account`(user_id);


alter table `heroku_9a602603f4f0dfb`.`newsletter_subscriber`
add constraint `FK_SUBSCRIBER_USER_ACCOUNT`
foreign key (subscriber_id)
references `heroku_9a602603f4f0dfb`.`user_account`(user_id);


alter table `heroku_9a602603f4f0dfb`.`rating`
...
alter table `heroku_9a602603f4f0dfb`.`category`
add constraint `FK_CATEGORY_SUPER`
foreign key (super_cat_id)
references `heroku_9a602603f4f0dfb`.`category`(cat_id);


alter table `heroku_9a602603f4f0dfb`.`product`
...
alter table `heroku_9a602603f4f0dfb`.`auto_bidding_job`
add constraint `FK_PRODUCT_AUTO_BIDDING_JOB`
foreign key (product_id)
references `heroku_9a602603f4f0dfb`.`product`(product_id);


alter table `heroku_9a602603f4f0dfb`.`product_detail`
...
alter table `heroku_9a602603f4f0dfb`.`wishlist`
...
alter table `heroku_9a602603f4f0dfb`.`join_bidder`
